...
public class ConditionVO {
    ...
    @ApiModelProperty(name = "relationId", value = "好友关系id", dataType = "Integer")
    private Integer relationId;

    @ApiModelProperty(name = "privacyInfoId", value = "隐私信息id", dataType = "Integer")
    private Integer privacyInfoId;

    @ApiModelProperty(name = "privacyTypeId", value = "隐私类型id", dataType = "Integer")
    private Integer privacyTagId;


    @ApiModelProperty(name = "id", value = "通用查询id", dataType = "Integer")
    private Integer id;
}
