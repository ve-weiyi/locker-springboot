...
import com.ve.locker.service.impl.UserDetailsServiceImpl;
...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    IOException {
        ...
        if (authHeader != null && authHeader.startsWith(tokenHead)){
            LogUtil.println("2. jwt令牌："+authHeader);
            ...
            if (userName != null && SecurityContextHolder.getContext().getAuthentication() == null){
                LogUtil.println("3.token有效，授权成功-->登录用户："+userName);
                //登录
            ...
            LogUtil.println("无令牌-->"+authHeader);
        }
        //放行，但没有setAuthentication，后续会拦截
       // LogUtil.println("url-->"+httpServletRequest.getRequestURL());
