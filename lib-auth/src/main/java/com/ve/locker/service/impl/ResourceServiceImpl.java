...
import com.ve.locker.dao.ResourceDao;
import com.ve.locker.dao.RoleResourceDao;
import com.ve.locker.dto.LabelOptionDTO;
import com.ve.locker.dto.ResourceDTO;
import com.ve.locker.entity.Resource;
import com.ve.locker.entity.RoleResource;
import com.ve.locker.exception.BizException;
import com.ve.locker.handler.FilterInvocationSecurityMetadataSourceImpl;
import com.ve.locker.service.ResourceService;
...
import static com.ve.locker.constant.CommonConst.FALSE;
...
public class ResourceServiceImpl extends ServiceImpl<ResourceDao, Resource> implements ResourceService {
    ...
    private String path= "/com/ve/locker/api";

    private String swaggerUrl=String.format("http://localhost:%s%s/v2/api-docs", port, path);
    ...
    public void importSwagger() {
        ...
        Map<String, Object> data = restTemplate.getForObject(swaggerUrl, Map.class);
        // 获取所有模块
